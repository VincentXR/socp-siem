  ...
  <div class="page-pad view-enter">
    <el-tabs v-model="ingestTab" @tab-change="onIngestTab">
      ...
      <el-tab-pane :label="t('ingest.rulesTab')" name="rules">
        <div style="margin-bottom:12px"><el-button type="primary" @click="showRuleDialog = true">{{ t('ingest.addParseRule') }}</el-button><el-button @click="loadParseRules">{{ t('ingest.refresh') }}</el-button><span style="color:var(--ns-text-3);font-size:12px;margin-left:8px">{{ t('ingest.parserHint') }}</span></div>
