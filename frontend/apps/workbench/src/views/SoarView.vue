  ...
  <div class="page-pad view-enter">
    ...
    <el-card shadow="never">
      <el-table :data="playbooks" size="small" border>
        ...
        <el-table-column :label="t('soar.actionChain')" min-width="260"><template #default="{ row }"><el-tag v-for="action in row.actions" :key="action" size="small" class="soar-action-tag">{{ action }}</el-tag></template></el-table-column>
