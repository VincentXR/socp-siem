...
<template>
  <div class="page-pad view-enter">
    ...
    <el-row :gutter="12" style="margin-bottom:14px">
      ...
      <el-col :span="6"><el-card shadow="never"><div class="stat-card"><div class="num" style="color:var(--ns-danger)">{{ gasStat.alertCount ?? 0 }}</div><div class="label">{{ t('detect.alarmsCount') }}</div></div></el-card></el-col>
