import {
  assetStats, createAsset, deleteAsset, endpointStats, deleteEndpoint, importAssets, listAssets, listEndpointEvents, listEndpoints, updateAsset,
} from './assets'
import type { EndpointEvent } from './assets'
import { caseStats, caseTimeline, createCase, createCaseFromAlarm, exportCases, listCases, setCaseStatus } from './incidents'
...
export const endpointApi = { list: listEndpoints, events: listEndpointEvents, stats: endpointStats, remove: deleteEndpoint }
export const caseApi = { list: listCases, stats: caseStats, timeline: caseTimeline, create: createCase, createFromAlarm: createCaseFromAlarm, updateStatus: setCaseStatus, export: exportCases }
