...
export const listChannels = () => get<Paged<Channel>>('/notify-web/api/v1/channels')
...
export const dispatchLog = () => get<Paged<DispatchLogEntry>>('/notify-web/api/v1/dispatch-log')
