...
public record TimelineEvent(Instant ts, String type, String message, String source, String alarmId,
    ...
    public TimelineEvent(Instant ts, String type, String message, String source, String alarmId) {
        this(ts, type, message, source, alarmId, alarmId == null ? null : "alarm:" + alarmId);
    }
}
