...
import com.socp.detect.model.persistence.SecondaryAnalysisPersistenceConfiguration;
import com.socp.detect.model.persistence.store.AnalysisReceiptStore;
import com.socp.detect.web.DetectWebApplication;
...
@DataJpaTest(properties = {
        "socp.detect.model.datasource.url=jdbc:h2:mem:secondary-analysis-repository;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
        ...
        "socp.detect.model.flyway.url=jdbc:h2:mem:secondary-analysis-repository;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
        "socp.detect.model.flyway.user=sa",
        "socp.detect.model.flyway.password="
})
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@Import({AnalysisReceiptStore.class, SecondaryAnalysisPersistenceConfiguration.class})
@ContextConfiguration(classes = DetectWebApplication.class)
