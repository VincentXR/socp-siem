...
class ModelControllerTest {
    ...
    @Test
    void isHostedOnTheDetectionWorkerCompatibilitySurface() {
        RequestMapping mapping = ModelController.class.getAnnotation(RequestMapping.class);
        DetectRuntimeRole role = ModelController.class.getAnnotation(DetectRuntimeRole.class);

        assertThat(mapping.value()).containsExactly("/model/api/v1");
        assertThat(role.value()).containsExactly(DetectRuntimeRole.Role.WORKER);
    }
