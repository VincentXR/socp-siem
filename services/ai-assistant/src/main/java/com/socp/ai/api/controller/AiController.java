...
public class AiController {
    ...
    @PostMapping("/ask")
    public ApiResult<AiResult> ask(@Valid @RequestBody AiAskRequest request) {
        return ApiResult.ok(service.ask(request.question()));
    }
    ...
    public ApiResult<java.util.Map<String, Object>> getInvestigation(@PathVariable String id) {
        return ApiResult.ok(investigation.get(id));
    }
    ...
    public ApiResult<java.util.Map<String, Object>> appendToIncident(
        ...
        return ApiResult.ok(investigation.appendToIncident(id, request == null ? null : request.incidentId()));
    }
}
