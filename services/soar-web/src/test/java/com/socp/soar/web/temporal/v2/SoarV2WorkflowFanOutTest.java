 ...
 */
class SoarV2WorkflowFanOutTest {
    ...
    void foreachRunsEveryItemAndLastBranchWinsVariables() {
        String definition = new SoarV2WorkflowSupport.Def()
                .node("start", "START")
                .node("each", "FOREACH",
                        "config", SoarV2WorkflowSupport.obj(
                                "itemsPath", "items", "itemVariable", "item"),
                        "limits", SoarV2WorkflowSupport.obj("concurrency", 2))
    ...
    void parallelAllSuccessFailsRunWhenABranchFails() {
        ...
        harness.fake().overrideNode("b1", new SoarV2NodeResult(
