...
import static com.socp.soar.web.temporal.SoarWorkflowSupport.Def;
...
import static com.socp.soar.web.temporal.SoarWorkflowSupport.obj;
 ...
 */
class SoarWorkflowHumanGateTest {
    ...
    private SoarWorkflowSupport.ActivityFake fake() {
        return harness.fake();
    }
    ...
    void approveGateWithExactKeySucceeds() {
        ...
        harness.waitForMethod("markRunWaitingWithContext");
    ...
    void unknownResolveConfirmedSucceededContinuesTheRun() {
        harness.fake().overrideNode("act", new SoarNodeResult(
