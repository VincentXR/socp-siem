...
/** Exercises the real SoarService.healthBacklog() body against mocked counters. */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
class SoarServiceHealthBacklogTest {
    ...
    private SoarService service() {
        SoarService service = new SoarService(playbooks, versions, runs, dispatches, nodes, events,
