...
class TemporalConfigCoverageTest {
    ...
    void runtimePropertiesRoundTripEverySwitch() {
        ...
        assertThat(properties.isEvaluationEnabled()).isTrue();
        assertThat(properties.isControlPlaneEnabled()).isTrue();
        ...
        properties.setControlPlaneEnabled(false);
        ...
        assertThat(properties.isEvaluationEnabled()).isFalse();
        assertThat(properties.isControlPlaneEnabled()).isFalse();
    ...
    void workerFactorySkipsRegistrationWhenTemporalIsDisabled() {
        ...
        WorkerFactory factory = config.workerFactory(client(), activityStub(PlaybookActivity.class),
                activityStub(SoarActivity.class), properties);
    ...
    @Test
    void workerFactoryRegistersWorkerAndToleratesUnreachableServer() {
        TemporalWorkerConfig config = new TemporalWorkerConfig();
