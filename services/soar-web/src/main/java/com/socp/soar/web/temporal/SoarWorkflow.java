...
/** Durable graph runner for the SOAR control plane. */
@WorkflowInterface
public interface SoarWorkflow {

    String TASK_QUEUE = "SOCP_SOAR_DURABLE_TASK_QUEUE";

    @WorkflowMethod
    SoarWorkflowResult execute(SoarWorkflowRequest request);
