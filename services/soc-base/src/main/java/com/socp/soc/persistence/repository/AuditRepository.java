...
@Repository
public interface AuditRepository extends TenantScopedRepository<AuditEntity, Long> {
    java.util.Optional<AuditEntity> findByIdAndTenantId(Long id, String tenantId);
