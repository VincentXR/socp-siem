...
import com.socp.platform.auth.security.InMemoryServiceNonceStore;
 ...
 */
@Configuration
@Import({SocpJwtConfig.class, CollectorCredentialRegistry.class, InMemoryServiceNonceStore.class})
public class SocpAuthConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(authInterceptor)
                .addPathPatterns("/**")
                .excludePathPatterns("/actuator/health/**", "/actuator/info/**", "/health", "/error")
                .order(-100);
    }
}
